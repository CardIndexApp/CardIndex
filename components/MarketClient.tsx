...
const MarketAreaChart = dynamic(() => import('@/components/MarketAreaChart'), { ssr: false })
...
export default function MarketClient({ initialData }: { initialData?: MarketResponse | null }) {
  const [data, setData] = useState<MarketResponse | null>(initialData ?? null)
            ...
            <div style={{
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ marginTop: 10 }}>
                  ...
                  {loading ? <Skeleton h={20} w={70} /> : <Chg v={data?.overall?.change30d} size={20} />}
                </div>
              </div>

              <div style={{ borderTop: '1px solid var(--border)', paddingTop: 16 }}>
                <div style={{ fontSize: 9, color: 'var(--ink3)', letterSpacing: 1, marginBottom: 4 }}>7d change</div>
                {loading ? <Skeleton h={18} w={60} /> : <Chg v={data?.overall?.change7d} size={18} />}
