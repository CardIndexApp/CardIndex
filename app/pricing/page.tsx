...
const tiers = [
  {
    name: 'Free',
    tagline: 'Explore the market and start tracking cards',
    monthlyPrice: 0,
    annualPrice: 0,
    cta: 'Get started free',
    highlight: false,
    features: [
      { text: 'Card search', included: true },
      { text: 'Current market price + CardIndex Score', included: true },
      { text: 'Market Verdict (Buy / Hold / Sell)', included: true },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Standard gives you the full analytics suite — 12 panels covering price momentum, volatility, grade premiums, outlier detection, and more — plus price history charts and PDF export. Pro adds the full price analysis suite (VWAP, vs-market comparison, eBay listings), portfolio tracking with P&L reporting, and CSV export.',
  },
  {
